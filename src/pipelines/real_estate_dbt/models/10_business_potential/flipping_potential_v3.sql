with reduced_developed_properties as (
  ...
  where 
  (
  price < 180000 and state in ('UT', 'ID', 'AZ') and price > 45000
  and 
...
interior_sqft * predicted_current_rent_price_per_sqft * leased_percentage * 12 as estimated_monthly_income_sqft,
predicted_future_rent_price_per_sqft,
predicted_price_growth_percentage
