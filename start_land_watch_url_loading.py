                    ...
                    runnables=[
                        batch_v1.Runnable(
                            container=batch_v1.Runnable.Container(
                                ...
                                commands=[
                                    "-c",
                                    "Xvfb :99 -screen 0 1280x720x24 > /dev/null 2>&1 & sleep 2 && export DISPLAY=:99 && exec uv run scrapers/scrapers_logic/land_watch/run_land_watch_job_initialization.py"
                                ]
                            ),
